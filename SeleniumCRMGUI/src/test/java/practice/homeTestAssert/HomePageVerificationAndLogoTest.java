...
public class HomePageVerificationAndLogoTest {
...
//		}else {
//			System.out.println(expected+"page is verified==FAIL");
//		}
//		
...
//		if(status) {
//			System.out.println(status+"page is verified==PASS");
//		}else {
//			System.out.println(status+"page is verified==FAIL");
//		}
//		
		driver.close();
		System.out.println(mtd.getName()+"Test End");
